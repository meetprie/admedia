        ...
        <div id="wrapper">
            <div id="main-contant" class="main-contant inner-page">
                ...
                <section id="contact-page" class="contact-page">
                    <div class="container">
                        <h2 class="title">اـــــنـــــب لـــــصـــــتا  </h2>
                            ...
                            <div class="address-detail for-mobile">
                                ...
                                <ul>
                                    <li class="address">
                                       ...
                                       <p> ،يبظوبأ ، 63:ديربلا قودنصةدحتملا ةيبرعلا تارامإلا  </p>
                                    </li>
                                    <li class="call">
                                        <span class="icon">
                                            <img class="lozad" data-src="images/phone.png">
                                        </span>
                                         <span>فتاهلا  : </span> <a href="#0" tel="024455555">02-4455555</a> 
                                    </li>
                                    <li class="call">
                                        <span class="icon">
                                            <img class="lozad" data-src="images/phone.png">
                                        </span>
                                         <span>يناجملا فتاهلا  : </span><a href="#0" tel="8003322">8003322</a> 
                                    </li>
                                    <li class="advertisement">
                                        <span class="icon">
                                            <img class="lozad" data-src="images/advertisement.png">
                                        </span>
                                         <label>يراجتلا نالعإلل  </label>
                            ...
                            <ul>
                                ...
                                <li class="advertisement">
                                    <span class="icon">
                                     ...
                                     <label>يراجتلا نالعإلل  </label>
                                      <span>لصتا  :</span> <a href="#0"> sales@admedia.ae </a>
                                </li>
                            </ul>
                        </div>

                        <div class="c-form">
                            <h2 class="title">لـــــصـــــتا جذوـــــمـــــن  </h2>
                            <form class="Content-form">
                                <div class="field">
                                    ...
                                    <div class="input-field">
                                        <input type="text" name="name" placeholder="مسالا*">
                                    </div>
                                    <div class="input-field">
                                        <input type="text" name="email" placeholder="ينورتكلإلا ديربلا*">
                                    </div>
                                </div>

                                <div class="field">
                                    <div class="input-field error">
                                        <label class="error">ﻟﺎﺻ ﺮﻴﻏ ﻢﻗر*</label>
                                        <input type="text" name="number" placeholder="لاوجلا مقر*">
                                    </div>
                                    <div class="input-radio">
                                        <label>:ةلضفملا لصاوتلا ةقيرط*</label>
                                        <span class="radio">
                                            <input type="radio" name="select-one" id="email">
                                            <label for="email">ينورتكلإلا ديربلا</label>
                                        </span>
                                        <span class="radio">
                                            <input type="radio" name="select-one" id="number">
                                            <label for="number">لاوجلا مقر  </label>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="field">
                                    <div class="textarea">
                                        <textarea placeholder="ةلاسرلا*"></textarea>
                                    </div>
                                </div>
