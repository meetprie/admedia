    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function uploadFile() {
              ...
              jQuery( ".Uploadedfile-name span" ).text( file.name );
            ...
            function progressHandler(event) {
                ...
                jQuery('.uploading-complete-done').removeClass('show-btn');
            ...
            jQuery(document).on("click", ".Uploadedfile-name", function () {
                jQuery(this).parents('.uploading-complete-done').addClass('show-btn');
            });

            jQuery(document).on("click", ".deleteUploaded-file .btn", function () {
                jQuery('.drop-zone').removeClass('uploading');
                jQuery('.drop-zone').removeClass('uploading-completed');
                jQuery('.drop-zone #file1').val("")
            });
            ...
            <div id="main-contant" class="main-contant inner-page brad-page content-hub">
                    ...
                    <div class="container">
                        <div class="content-hub">
                            <div class="sec-heading">
                                <h2 class="title">ىوتحــــــــملا عانــــــــص</h2>
                            </div>
                ...
                <section class="content-hub-form">
                    <div class="container">
                        ...
                        <div class="step-form">
                            <form class="Content-form web-form">
                                <div class="step-one-form">
                                    ...
                                    <div class="field">
                                        <label>الملف المسموح به : DOC, PDF</label>
                                        <div class="drop-zone">
                                            ...
                                            <div class="uploading-complete-done">
                                                ...
                                                <div class="removeUploaded-file">
                                                    <label>ةمالع ىلع طغضلاب مق فلملا فذحل   <img src="images/delete.png"></label>
                                                    <span class="Uploadedfile-name">
                                                        <img src="images/delete-icon.png">
                                                        <span>يحصلا ءاذغلا ماظن :فلم  </span>
                                                    </span>
                                                </div>
                                                <div class="deleteUploaded-file">
                                                    <a href="javascript:void(0)" class="btn">فلملا فذح</a>
                                                </div>                                                
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="submit-popup">
                                    ...
                                    <div class="white-box">
                                        ...
                                        <div class="text-center">
                                            <p>يقر مستخدم موقع أبوظبي للإعلام "صناع المحتوى" للموقع على مسؤوليته الخاصة للمادة ولا تتحمل أبوظبي للإعلام أي مسؤولية عن أي ضرر.</p>
                                        </div>
                                    </div>
                                </div>
